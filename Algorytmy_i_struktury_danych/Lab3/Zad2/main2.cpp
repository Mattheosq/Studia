...
void Sito_Atkin(Node** ptr2head,int grna_granica){
	...
	*/
	...
	bool sito[grna_granica + 1]; // tworze tablice wartosci binarnych i zapelniam ja poczatkowo wartosciami 0(false), pozniejsza zamiana na true bedzie oznaczac liczbe pierwsza
